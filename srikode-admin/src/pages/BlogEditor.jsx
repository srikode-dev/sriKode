                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          ...
                          <label className="flex items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-xs font-bold text-slate-600 px-4 py-2 cursor-pointer transition shrink-0">
                            {uploadingBlockImage ? <Loader className="h-3.5 w-3.5 animate-spin" /> : <Upload className="h-3.5 w-3.5" />}
                            Upload
                            <input
                              type="file"
                              accept="image/*"
                              onChange={(e) => handleImageUpload(e, (url) => updateBlock(index, { src: url }), setUploadingBlockImage)}
                              className="hidden"
                            />
                          </label>
                        </div>
